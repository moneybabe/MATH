...
legend("topleft",
    legend = c(paste("Test MAE =", round(ridge_mae[which.min(ridge_mae)], 2)),
        paste("lambda =", round(least_mae_ridge_lambda, 2))
    ),
    col = 1,
    lty = 1
)
...
legend("topleft",
    legend = c(paste("Test MAE =", round(lasso_mae[which.min(lasso_mae)], 2)),
        paste("lambda =", round(least_mae_lasso_lambda, 2))
    ),
    col = 1,
    lty = 1
)
...
legend("topleft",
    legend = c(paste("CV MAE =", 
        round(cv_mae_ridge[which.min(cv_mae_ridge)], 2)),
        paste("lambda =", round(optimal_lambda_ridge, 2))
    ),
    col = 1,
    lty = 1
)
...
legend("topleft",
    legend = c(paste("CV MAE =", 
        round(cv_mae_lasso[which.min(cv_mae_lasso)], 2)),
        paste("lambda =", round(optimal_lambda_lasso, 2))
    ),
    col = 1,
    lty = 1
)
